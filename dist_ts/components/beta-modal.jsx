...
export function BetaModal() {
    ...
    return (<Dialog open={isOpen} onOpenChange={handleOpenChange}>
      <DialogTrigger asChild>
        <Button className="bg-gradient-to-r from-blue-600 to-purple-600 px-8 py-6 text-lg font-medium hover:from-blue-700 hover:to-purple-700" onClick={() => setIsOpen(true)}>
      ...
      <DialogContent className="sm:max-w-md">
        ...
        {isSuccess ? (<div className="flex flex-col items-center justify-center py-6 text-center">
