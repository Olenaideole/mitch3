    ...
    return (<div className="container mx-auto px-4 py-16">
      ...
      <div className="mx-auto grid max-w-5xl gap-8 md:grid-cols-2">
        ...
        <Card className={`relative flex flex-col border-2 ${isPremium ? "border-blue-200 shadow-lg" : "shadow-lg"}`}>
          ...
          <CardFooter>
            {isPremium ? (<div className="w-full rounded-md bg-green-100 py-2 text-center font-medium text-green-800">
                Current Plan
              </div>) : (<Button onClick={handleGetPremium} disabled={isLoading} className="w-full bg-blue-600 py-6 text-lg font-medium hover:bg-blue-700">
                {isLoading ? (<>
