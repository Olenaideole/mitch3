      ...
      <main className="flex-1 bg-slate-50">
        <div className="container mx-auto px-4 py-12">
          ...
          {loading ? (<div className="flex items-center justify-center py-12">
              ...
              {scans.map((scan) => (<Card key={scan.id} className="overflow-hidden">
                  <div className="relative h-48 bg-slate-200">
                    {scan.image_url ? (<img src={scan.image_url || "/placeholder.svg"} alt="Food label" className="h-full w-full object-cover"/>) : (<div className="flex h-full items-center justify-center">
